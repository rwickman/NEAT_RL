...
def update_parser(parser):
    ...
    parser.add_argument("--replay_capacity", type=int, default=65536,
    ...
    parser.add_argument("--org_lr", type=float, default=0.00038,
    ...
    parser.add_argument("--pg_rate", type=float, default=0.62,
